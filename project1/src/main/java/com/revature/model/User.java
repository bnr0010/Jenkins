...
public class User implements Serializable {
	...
	public User(String firstName, String lastName, String username, String password, String email, int isManager) {
		super();
	...
	public String toString() {
		return "User [userId=" + userId + ", firstName=" + firstName + ", lastName=" + lastName + ", username="
				+ username + ", password=" + password + ", email=" + email + ", isManager=" + isManager + "]";
	}
